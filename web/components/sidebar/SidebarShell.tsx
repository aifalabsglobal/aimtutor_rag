    ...
    return (
      <aside className="group/sb relative flex h-screen w-[60px] shrink-0 flex-col items-center bg-[var(--secondary)] py-3 transition-all duration-200">
        ...
        <div className="relative mb-2 flex h-9 w-9 items-center justify-center">
          ...
          >
            <span className="aimtutor-wordmark aimtutor-wordmark--toolbar aimtutor-wordmark--compact">
  ...
  return (
    <aside className="flex w-[220px] h-screen shrink-0 flex-col bg-[var(--secondary)] transition-all duration-200">
      ...
      <div className="flex h-14 items-center gap-2 px-3.5">
        <Link href="/" className="group flex min-w-0 flex-1 items-center overflow-hidden">
          <span className="aimtutor-wordmark aimtutor-wordmark--toolbar max-w-full">
            <span className="aimtutor-wordmark__aim">Aim</span>
            <span className="aimtutor-wordmark__rest">Tutor</span>
            <span className="aimtutor-wordmark__tld">.ai</span>
          </span>
        ...
        <button
          ...
          className="shrink-0 rounded-md p-1 text-[var(--muted-foreground)] transition-colors hover:text-[var(--foreground)]"
